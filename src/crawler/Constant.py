...
HOME_PATH = "D:\\SENTIFI_DATA\\"

MENTION_PATH = HOME_PATH + "mention\\"
MENTION_INPUT = MENTION_PATH + "input\\"
MENTION_OUTPUT_PATH = MENTION_PATH + "output\\processing\\"

MENTION_HEADER = ['twitter_screen_name_user', 'tweet_id', 'tweet_text', 'tweet_create_time', 'twitter_id',
