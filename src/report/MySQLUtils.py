...
class MySQLUtils(object):
    ...
    def create_table(self, table_name, template_table):
        self.drop_table(table_name)
        self.cursor.execute(
            """CREATE TABLE '{0}' LIKE '{1}' """ .format(table_name, template_table)
        )


    def call_proc(self, proc_name, params):
        self.cursor.callproc('abc', (params))
    ...
    def check_table_exists(table_name):
        connection = mdb.connect(SERVER, USERNAME, PASSWORD, DATABASE_NAME, charset='utf8')
...
mysql = MySQLUtils()
#print mysql.check_table_exists('24_09_searched_profiles_from_twitter')

params = ['JesseLivermore3']
print mysql.call_proc('abc', params)
