...
class Ruler(object):
    ...
    @staticmethod
    def get_rules(self, stage_name, field_name, class_name):
...
Ruler().get_rule_subset_by_phase_field_parent('Category 1', 1, 'Financial Market Professionals') # 242 rows