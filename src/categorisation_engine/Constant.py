...
FIELD_TWITTER_DESCRIPTION = 'TWITTER DESCRIPTION'
FIELD_TWITTER_SCREEN_NAME = 'TWITTER SCREEN NAME'
FIELD_TWITTER_FULL_NAME = 'TWITTER FULL NAME'

TWITTER_DESCRIPTION = 'TWITTER DESCRIPTION'
TWITTER_SCREEN_NAME = 'TWITTER SCREEN NAME'
TWITTER_FULL_NAME = 'TWITTER FULL NAME'
